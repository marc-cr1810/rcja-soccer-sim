...
import { AgentSlot, LocalTransport, sanitise, type Agent } from '../../src/match/agent';
import { Senses, TeamRadio, type MatchView, type SensedRobot } from '../../src/sim/perception';
import type { ActuatorFrame, SensorFrame } from '../../src/match/protocol';
