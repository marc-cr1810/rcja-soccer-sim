...
import { waitForSeats } from '../league/bench';
import { parseManifest, slugifyTeam, TOKEN_FILENAME, type Manifest } from '../infra/manifest';
import { spawnSandboxed } from '../match/sandbox';
