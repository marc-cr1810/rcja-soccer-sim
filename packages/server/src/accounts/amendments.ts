...
import { fail, ok, type Result } from '../infra/manifest';
import { walkoverResult } from '../match/pregame';
import type { Draw, Fixture, FixtureResult, LegRecord } from '../league/tournament';
