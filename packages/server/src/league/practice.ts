...
import { Match, SEAT_IDS, type SeatId } from '../match/match';
import { resolveLineup, spawnSeat, type LineupEntry, type SeatProcess } from '../accounts/lineup';
import { WorkspaceStore } from '../accounts/workspace';
import { ReferenceAgent } from '../infra/reference';
...
import { defaultSpot, type Arrangement, type PlacedRobot, type TeamId } from '../sim/world';
