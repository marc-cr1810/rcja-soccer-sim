...
class TestProto(unittest.TestCase):
    ...
    def test_decode_server_message_sensors(self) -> None:
        ...
        sub.string(3, "violet")
        sub.int32(4, 1)
        sub.double(1, 99.0)  # protocol 5's match clock: must not come back as anything
