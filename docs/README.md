...
Five things, in the order a team actually needs them:
...
3. **[Practising](practising.md)** — a practice field: your own robots on a
   field you arrange by hand, started and stopped as you like, scored by
   nobody.
4. **[python/README.md](../python/README.md)** — the full reference for what
   ...
   library.
5. **[Running a tournament](running-a-tournament.md)** — for whoever is
