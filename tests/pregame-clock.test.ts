...
import { decided, penaltyGoals, walkoverResult, wholeMinutes } from '../src/pregame';
import type { PregameVerdict } from '../src/pregame';
import { makeDraw } from '../src/tournament';
import { saveDraw, loadResults } from '../src/tournament-store';
import type { Fixture, FixtureResult } from '../src/tournament';
...
describe('a fixture nobody turned up for', () => {
  ...
  it(
    ...
    async () => {
      ...
      const { saveResult } = await import('../src/tournament-store');
