...
import { AgentSlot, LocalTransport, sanitise, type Agent } from '../src/agent';
import { Senses, TeamRadio, type MatchView, type SensedRobot } from '../src/perception';
import type { ActuatorFrame, SensorFrame } from '../src/protocol';
