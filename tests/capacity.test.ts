...
import { arenaGrant, refuseToStart, resolveBudget, type Machine } from '../src/capacity';
import { defaultSettings, loadSettings, saveSettings, type LeagueSettings } from '../src/settings';
